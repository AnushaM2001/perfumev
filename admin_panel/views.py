...
# def notify_admins(user, message, category="orders"):
#     # Save notification
#     Notification.objects.create(user=user, message=message, category=category)

#     # Fresh counts filtered by this user
#     counts = {
#         "orders": Notification.objects.filter(user=user, category="orders", is_read=False).count(),
#         "stocks": Notification.objects.filter(user=user, category="stocks", is_read=False).count(),
#         "queries": Notification.objects.filter(user=user, category="queries", is_read=False).count(),
#     }
